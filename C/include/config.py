...
return_bridge_types = ["C4SliceResult", "C4Slice", "size_t", "byte*"]
...
"c4key_withBytes":".bridge .C4Key* c4key_withBytes C4Slice_b:slice","c4queryenum_customColumns":".bridge .C4SliceResult_b c4queryenum_customColumns C4QueryEnumerator*:e"}
reserved = ["string"]
