...
param_bridge_types = ["C4Slice", "size_t", "size_t*"]
return_bridge_types = ["C4SliceResult", "C4Slice", "size_t"]
type_map = {"int32_t":"int","uint32_t":"uint","int64_t":"long","uint64_t":"ulong","size_t":"UIntPtr","size_t*","UIntPtr*","C4SequenceNumber":"ulong","C4SequenceNumber*":"ulong*","unsigned":"uint"}
