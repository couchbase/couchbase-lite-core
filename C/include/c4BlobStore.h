...
C4API_BEGIN_DECLS
    ...
    CBL_CORE_API C4BlobStore* c4blob_openStore(C4String dirPath,
    ...
    /** Stores a blob. The associated key will be written to `outKey`, if non-NULL.
        ...
        have that key. */
    CBL_CORE_API bool c4blob_create(C4BlobStore *store,
                       C4Slice contents,
    ...
    CBL_CORE_API C4ReadStream* c4blob_openReadStream(C4BlobStore*,
                                        C4BlobKey,
    ...
    CBL_CORE_API size_t c4stream_read(C4ReadStream* stream,
                         void *buffer,
    ...
    /** Moves to a random location in the stream; the next c4stream_read call will read from that
        location. */
    CBL_CORE_API bool c4stream_seek(C4ReadStream*,
                       uint64_t position,
                       C4Error* C4NULLABLE) C4API;
    ...
    CBL_CORE_API C4WriteStream* c4blob_openWriteStream(C4BlobStore*,
                                          C4Error* C4NULLABLE) C4API;

    /** Writes data to a stream. */
    CBL_CORE_API bool c4stream_write(C4WriteStream*,
                        const void *bytes,
                        size_t length,
                        C4Error* C4NULLABLE) C4API;
    ...
    CBL_CORE_API bool c4stream_install(C4WriteStream*,
                          const C4BlobKey* C4NULLABLE expectedKey,
                          C4Error* C4NULLABLE) C4API;
