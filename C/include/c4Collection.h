...
/** Creates and returns an empty collection with the given name & scope.
    ...
    @note Be sure to read `C4Collection` Lifespan in c4Collection.h. */
CBL_CORE_API C4Collection* C4NULLABLE c4db_createCollection(C4Database* db, C4CollectionSpec spec,
                                                            C4Error* C4NULLABLE outError) C4API;
...
CBL_CORE_API bool c4db_deleteCollection(C4Database* db, C4CollectionSpec spec, C4Error* C4NULLABLE outError) C4API;
...
CBL_CORE_API FLMutableArray c4db_collectionNames(C4Database* db, C4String inScope, C4Error* C4NULLABLE outError) C4API;

/** Returns the names of all existing scopes, in the order in which they were created.
    @note  You are responsible for releasing the returned Fleece array. */
CBL_CORE_API FLMutableArray c4db_scopeNames(C4Database* db, C4Error* C4NULLABLE outError) C4API;
...
CBL_CORE_API C4Document* C4NULLABLE c4coll_getDoc(C4Collection* collection, C4String docID, bool mustExist,
...
CBL_CORE_API C4Document* C4NULLABLE c4coll_getDocBySequence(C4Collection*       collection, C4SequenceNumber,
                                                            C4Error* C4NULLABLE outError) C4API;
...
CBL_CORE_API C4Document* C4NULLABLE c4coll_putDoc(C4Collection* collection, const C4DocPutRequest* request,
...
CBL_CORE_API C4Document* C4NULLABLE c4coll_createDoc(C4Collection* collection, C4String docID, C4Slice body,
                                                     C4RevisionFlags revisionFlags, C4Error* C4NULLABLE error) C4API;
...
CBL_CORE_API bool c4coll_moveDoc(C4Collection* collection, C4String docID, C4Collection* toCollection,
...
CBL_CORE_API bool c4coll_purgeDoc(C4Collection* collection, C4String docID, C4Error* C4NULLABLE outError) C4API;
...
CBL_CORE_API bool c4coll_setDocExpiration(C4Collection* collection, C4String docID, C4Timestamp timestamp,
                                          C4Error* C4NULLABLE outError) C4API;
...
CBL_CORE_API int64_t c4coll_purgeExpiredDocs(C4Collection*, C4Error* C4NULLABLE) C4API;
...
/** Creates a collection index, of the values of specific expressions across all documents.
    ...
    @return  True on success, false on failure. */
CBL_CORE_API bool c4coll_createIndex(C4Collection* collection, C4String name, C4String indexSpec,
                                     C4QueryLanguage queryLanguage, C4IndexType indexType,
                                     const C4IndexOptions* C4NULLABLE indexOptions, C4Error* C4NULLABLE outError) C4API;
...
/** Deletes an index that was created by `c4coll_createIndex`.
    ...
    @param outError  On failure, will be set to the error status.
    @return  True on success, false on failure. */
CBL_CORE_API bool c4coll_deleteIndex(C4Collection* collection, C4String name, C4Error* C4NULLABLE outError) C4API;
