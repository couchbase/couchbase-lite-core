...
typedef void (*C4ReplicatorStatusChangedCallback)(C4Replicator*, C4ReplicatorStatus, void* C4NULLABLE context);
...
typedef bool (*C4ReplicatorValidationFunction)(C4CollectionSpec collectionSpec, C4String docID, C4String revID,
                                               C4RevisionFlags, FLDict body, void* C4NULLABLE context);
...
typedef struct C4ReplicatorParameters {
    ...
    C4ReplicatorStatusChangedCallback C4NULLABLE
            onStatusChanged;  ///< Callback to be invoked when replicator's status changes.
    C4ReplicatorDocumentsEndedCallback C4NULLABLE
            onDocumentsEnded;  ///< Callback notifying status of individual documents
...
#define kC4ReplicatorOptionAcceptParentDomainCookies "acceptParentDomainCookies"
    #define kC4ReplicatorOptionAllowConnectedClient "allowConnectedClient" ///< Allow peer to use connected-client (CRUD) API
...
#define kC4SocketOptionNetworkInterface                                                                                \
    "networkInterface"  ///< Specific network interface (name or IP address) used for connecting to the remote server.
