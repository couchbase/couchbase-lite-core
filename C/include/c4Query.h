...
C4API_BEGIN_DECLS
    ...
    CBL_CORE_API C4Query* c4query_new2(C4Database *database,
    ...
    CBL_CORE_API C4QueryEnumerator* c4query_run(C4Query *query,
    ...
    CBL_CORE_API bool c4queryenum_next(C4QueryEnumerator *e,
                          C4Error* C4NULLABLE outError) C4API;
    ...
    CBL_CORE_API int64_t c4queryenum_getRowCount(C4QueryEnumerator *e,
                                     C4Error* C4NULLABLE outError) C4API;
    ...
    CBL_CORE_API bool c4queryenum_seek(C4QueryEnumerator *e,
                          int64_t rowIndex,
                          C4Error* C4NULLABLE outError) C4API;
    ...
    CBL_CORE_API C4QueryEnumerator* c4queryenum_refresh(C4QueryEnumerator *e,
                                           C4Error* C4NULLABLE outError) C4API;
