...
CBL_CORE_API bool c4repl_isValidRemote(C4Address remoteAddress, C4String remoteDatabaseName,
...
CBL_CORE_API bool c4address_fromURL(C4String url, C4Address* address, C4String* C4NULLABLE dbName) C4API;
...
CBL_CORE_API C4Replicator* c4repl_new(C4Database* db, C4Address remoteAddress, C4String remoteDatabaseName,
...
/** Creates a new replicator to another local database.
        ...
        @param outError  Error, if replication can't be created.
        @return  The newly created replicator, or NULL on error. */
CBL_CORE_API C4Replicator* c4repl_newLocal(C4Database* db, C4Database* otherLocalDB, C4ReplicatorParameters params,
                                           C4Error* C4NULLABLE outError) C4API;
#endif
...
/** Checks if the document with the given ID has revisions pending push.  This
     ...
     */
CBL_CORE_API bool c4repl_isDocumentPending(C4Replicator* repl, C4String docID, C4CollectionSpec spec,
                                           C4Error* C4NULLABLE outErr) C4API;


/** Gets the TLS certificate, if any, that was sent from the remote server (NOTE: Only functions when using BuiltInWebSocket) */
CBL_CORE_API C4Cert* c4repl_getPeerTLSCertificate(C4Replicator* repl, C4Error* C4NULLABLE outErr) C4API;
...
/** Sets the progress level of the replicator, indicating what information should be provided via
     ...
     */
CBL_CORE_API bool c4repl_setProgressLevel(C4Replicator* repl, C4ReplicatorProgressLevel level,
                                          C4Error* C4NULLABLE outErr) C4API;
...
/** Takes the value of a "Set-Cookie:" header, received from the given host, from an HTTP
     ...
     */
CBL_CORE_API bool c4db_setCookie(C4Database* db, C4String setCookieHeader, C4String fromHost, C4String fromPath,
                                 bool acceptParentDomain, C4Error* C4NULLABLE outError) C4API;
