...
TEST_CASE_METHOD(ReplicatorWalrusTest, "KeepBody of Latest Synced Rev", "[.SyncServer]") {
    string revID;
    slice  docID = "Doc"_sl;
    {
        TransactionHelper t(db);
...

    {
        ...
        FLError flError;
        alloc_slice res = _sg.sendRemoteRequest("PUT", docID.asString(), enc.finish(), false, HTTPStatus::Created, false);
