...
public:
    ...
    MutableDict encryptProperties(Dict doc) {
        _numCallbacks = 0;
        C4Error error;
    ...
    MutableDict encryptProperties(slice json) {
        
        Doc doc = Doc::fromJSON(json);
        auto result = encryptProperties(doc.asDict());
...
public:
    ...
    MutableDict decryptProperties(Dict doc) {
        _numCallbacks = 0;
        C4Error error;
    ...
    MutableDict decryptProperties(slice json) {

        Doc doc = Doc::fromJSON(json);
        auto result = decryptProperties(doc.asDict());
