...
namespace litecore::repl {
    ...
    class Pusher final
      ...
      private:
        ...
        void handleSubChanges(Ref<blip::MessageIn> req);
        ...
        void                     handleGetAttachment(Ref<blip::MessageIn>);
        void                     handleProveAttachment(Ref<blip::MessageIn>);
        ...
        void        sendRevision(Ref<RevToSend>);
        void        onRevProgress(const Ref<RevToSend>& rev, const blip::MessageProgress&);
        ...
        using DocIDToRevMap = std::unordered_map<alloc_slice, Ref<RevToSend>>;
        ...
        std::deque<Ref<RevToSend>> _revQueue;                       // Revs to send to peer but not sent yet
