...
static const char *TAG = "lite-core::CppTests";
...
extern "C"
jstring
Java_com_couchbase_lite_cpptests_MainActivity_runCppTest(
        JNIEnv *env,
        jobject jobj,
        jstring jpath) {
    ...
    const int argc = 3;
    const char *argv[argc] = {(char*)"CppTests", (char*)"-r", (char*)"list"};
    int result = Catch::Session().run(argc, argv);
    //int result = ::Catch_Session_Run(argc, argv);
    close_logger();
