...
adb push ../C/tests/names_100.json         /data/local/tmp/LiteCore/C/tests/names_100.json 
adb push ../C/tests/iTunesMusicLibrary.json /data/local/tmp/LiteCore/C/tests/iTunesMusicLibrary.json 
