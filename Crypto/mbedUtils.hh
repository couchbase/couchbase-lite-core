...
namespace litecore::crypto {
    ...
    void parsePEMorDER(slice data, const char* what, CTX* context, int (*cfn)(CTX*, const uint8_t*, size_t)) {
        parsePEMorDER(data, what, [=](const uint8_t* bytes, size_t size) { return cfn(context, bytes, size); });
    }
