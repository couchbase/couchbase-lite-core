...
namespace litecore::net {
    ...
    class HTTPLogic {
      public:
        ...
        void setContentLength(uint64_t length) { _contentLength = fleece::narrow_cast<int64_t>(length); }
        ...
        void setWebSocketProtocol(slice p) {
            _webSocketProtocol = p;
            _isWebSocket       = true;
        }
        ...
        static void setDefaultProxy(std::optional<ProxySpec> p) { sDefaultProxy = std::move(p); }

        static std::optional<ProxySpec> defaultProxy() { return sDefaultProxy; }
        ...
        [[nodiscard]] bool isChallengeAuthEnabled() const { return _enableChallengeAuth; }
