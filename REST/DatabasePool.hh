...
namespace litecore::REST {
    ...
    class DatabasePool {
      ...
      private:
        ...
        fleece::Retained<C4Database>              _readwrite;       // The available RW DB
    };
    ...
    class BorrowedDatabase {
      public:
        ...
        ~BorrowedDatabase() {
            if ( _pool ) _pool->returnDatabase(_db);
        }
      ...
      protected:
        ...
        BorrowedDatabase(C4Database* db, DatabasePool& pool) : _db(db), _pool(&pool) {}
