...
namespace litecore {
    ...
    int CompareUTF8(fleece::slice str1, fleece::slice str2, const CollationContext&) { error::_throw(error::Unimplemented); }

    bool ContainsUTF8(fleece::slice str, fleece::slice substr, const CollationContext&) { error::_throw(error::Unimplemented); }
