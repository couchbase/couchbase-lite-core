...
#    define MIGRATE_1(from, to)                                                                                        \
        from(const char* const arg1) {                                                                                 \
            CA2WEX<256> wide(arg1, CP_UTF8);                                                                           \
            return to(wide);                                                                                           \
        }

#    define MIGRATE_2(from, to, type1)                                                                                 \
        from(const char* const arg1, type1 arg2) {                                                                     \
            CA2WEX<256> wide(arg1, CP_UTF8);                                                                           \
            return to(wide, arg2);                                                                                     \
        }

#    define MIGRATE_2S(from, to)                                                                                       \
        from(const char* const arg1, const char* const arg2) {                                                         \
            CA2WEX<256> wide1(arg1, CP_UTF8);                                                                          \
            CA2WEX<256> wide2(arg2, CP_UTF8);                                                                          \
            return to(wide1, wide2);                                                                                   \
        }

#    define MIGRATE_ARG(arg, retVal)                                                                                   \
        CA2WEX<256> w##arg(arg, CP_UTF8);                                                                              \
        return retVal

    int mkdir_u8(const char* path, int mode) { MIGRATE_ARG(path, ::_wmkdir(wpath)); }
