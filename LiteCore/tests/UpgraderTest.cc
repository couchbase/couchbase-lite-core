...
class UpgradeTestFixture : public TestFixture {
  protected:
    ...
    void upgrade(const string& oldPath, C4DocumentVersioning versioning) {
        static constexpr char const* kVersioningName[3] = {"v2 rev trees", "v3 rev trees", "version vectors"};
    ...
    void upgradeInPlace(const string& fixturePath, const C4DocumentVersioning versioning) {
        ...
        snprintf(folderName, bufSize, "%" PRIms "%s/", chrono::milliseconds(time(nullptr)).count(),
                 srcPath.fileOrDirName().c_str());
        ...
        ExpectException(error::LiteCore, error::DatabaseTooOld, [&] { db = DatabaseImpl::open(dbPath, config); });
    ...
    void verifyDoc(slice docID, slice bodyJSON, const vector<slice>& revIDs) {
        ...
        if ( _versioning != kC4VectorVersioning ) {
            ...
            for ( slice revID : revIDs ) {
                if ( i++ > 0 ) CHECK(doc1->selectNextRevision());
    ...
    void verifyAttachment(const string& digest) {
...
#define GENERATE_VERSIONING()                                                                                          \
    C4DocumentVersioning(GENERATE((int)kC4TreeVersioning_v2, (int)kC4TreeVersioning, (int)kC4VectorVersioning))
...
TEST_CASE_METHOD(UpgradeTestFixture, "Upgrade from Android 1.2", "[Upgrade]") {
    ...
    verifyDoc(
            "doc1"_sl,
            R"({"key":"1","_attachments":{"attach1":{"length":7,"digest":"sha1-P1i5kI/sosq745/9BDR7kEghKps=","revpos":2,"content_type":"text/plain; charset=utf-8","stub":true}}})",
            {"2-db9941f74d7fd45d60c272b796ae50c7"_sl, "1-e2a2bdc0b00e32ecd0b6bc546024808b"_sl});
    verifyDoc(
            "doc2"_sl,
            R"({"key":"2","_attachments":{"attach2":{"length":7,"digest":"sha1-iTebnQazmdAhRBH64y9E6JqwSoc=","revpos":2,"content_type":"text/plain; charset=utf-8","stub":true}}})",
...
TEST_CASE_METHOD(UpgradeTestFixture, "Upgrade from Android 1.3", "[Upgrade]") {
    ...
    verifyDoc(
            "doc1"_sl,
            R"({"_attachments":{"attach1":{"length":7,"digest":"sha1-P1i5kI/sosq745/9BDR7kEghKps=","revpos":2,"content_type":"plain/text","stub":true}},"key":"1"})",
            {"2-6422c597f66f74bf73014f78ac85724f"_sl, "1-e2a2bdc0b00e32ecd0b6bc546024808b"_sl});
    verifyDoc(
            "doc2"_sl,
            R"({"_attachments":{"attach2":{"length":7,"digest":"sha1-iTebnQazmdAhRBH64y9E6JqwSoc=","revpos":2,"content_type":"plain/text","stub":true}},"key":"2"})",
...
TEST_CASE_METHOD(UpgradeTestFixture, "Upgrade from iOS 1.2", "[Upgrade]") {
    ...
    verifyDoc(
            "doc1"_sl,
            R"({"_attachments":{"attach1":{"content_type":"text/plain; charset=utf-8","digest":"sha1-P1i5kI/sosq745/9BDR7kEghKps=","length":7,"revpos":2,"stub":true}},"boolean":true,"date":"2016-01-15T23:08:40.803Z","foo":"bar","number":1,"type":"doc"})",
            {"2-f34206d6bd05b187b3f4fdd232174ac7"_sl, "1-d24e23f21c4f5b9ee83ce7e2493e0334"_sl});
    verifyDoc(
            "doc2"_sl,
            R"({"_attachments":{"attach2":{"content_type":"text/plain; charset=utf-8","digest":"sha1-iTebnQazmdAhRBH64y9E6JqwSoc=","length":7,"revpos":2,"stub":true}},"boolean":true,"date":"2016-01-15T23:08:40.816Z","foo":"bar","number":2,"type":"doc"})",
...
TEST_CASE_METHOD(UpgradeTestFixture, "Upgrade from iOS 1.3", "[Upgrade]") {
    ...
    verifyDoc(
            "doc1"_sl,
            R"({"_attachments":{"attach1":{"content_type":"text/plain; charset=utf-8","digest":"sha1-P1i5kI/sosq745/9BDR7kEghKps=","length":7,"revpos":2,"stub":true}},"boolean":true,"date":"2016-07-07T03:12:13.471Z","foo":"bar","number":1,"type":"doc"})",
            {"2-b9a637ed67d8bd3a34eb85d1ceb2a4b6"_sl, "1-8feb542236ef8bedaf555b57211c5c3e"_sl});
    verifyDoc(
            "doc2"_sl,
            R"({"_attachments":{"attach2":{"content_type":"text/plain; charset=utf-8","digest":"sha1-iTebnQazmdAhRBH64y9E6JqwSoc=","length":7,"revpos":2,"stub":true}},"boolean":true,"date":"2016-07-07T03:12:13.508Z","foo":"bar","number":2,"type":"doc"})",
...
TEST_CASE_METHOD(UpgradeTestFixture, "Upgrade from .NET 1.2", "[Upgrade]") {
    ...
    verifyDoc(
            "doc1"_sl,
            R"({"_attachments":{"attach1":{"content_type":"image/png","digest":"sha1-1uqCkSGvnQJexh2BV/z46ktEUSk=","length":38790,"revpos":2,"stub":true}},"description":"Jim's avatar"})",
            {"2-a85b8292de5f5490b3895d76d85f9432"_sl, "1-c84f0703d05821ba47412226ed0bfb20"_sl});
    verifyDoc(
            "doc2"_sl,
            R"({"_attachments":{"attach2":{"content_type":"application/pgp-keys","digest":"sha1-aTohES5UC/zBwIXuCNAhQ0BtajQ=","length":1706,"revpos":2,"stub":true}},"description":"Jim's public key"})",
...
TEST_CASE_METHOD(UpgradeTestFixture, "Upgrade from .NET 1.3", "[Upgrade]") {
    ...
    verifyDoc(
            "doc1"_sl,
            R"({"_attachments":{"attach1":{"content_type":"image/png","digest":"sha1-v1M1+8aDtoX7zr6cJ2O7BlaaPAo=","length":10237,"revpos":2,"stub":true}},"description":"Jim's avatar"})",
            {"2-0648b6fe63bcc97db824a6d911b6aafc"_sl, "1-cd809becc169215072fd567eebd8b8de"_sl});
    verifyDoc(
            "doc2"_sl,
            R"({"_attachments":{"attach1":{"content_type":"application/pgp-keys","digest":"sha1-vX2fVqJf4pIbehLdk0L2cB4QXzI=","length":1736,"revpos":2,"stub":true}},"description":"Jim's public key"})",
