...
#    define UTF16_NEXT_CHAR_UNSAFE(s, i, c)                                                                            \
        {                                                                                                              \
            (c) = (s)[(i)++];                                                                                          \
            if ( UTF_IS_FIRST_SURROGATE(c) ) { (c) = UTF16_GET_PAIR_VALUE((c), (s)[(i)++]); }                          \
        }
...
#    define UTF16_PREV_CHAR_UNSAFE(s, i, c)                                                                            \
        {                                                                                                              \
            (c) = (s)[--(i)];                                                                                          \
            if ( UTF_IS_SECOND_SURROGATE(c) ) { (c) = UTF16_GET_PAIR_VALUE((s)[--(i)], (c)); }                         \
        }
...
#    define UTF32_GET_CHAR_SAFE(s, start, i, length, c, strict)                                                        \
        {                                                                                                              \
            (c) = (s)[i];                                                                                              \
            if ( !UTF32_IS_SAFE(c, strict) ) { (c) = UTF_ERROR_VALUE; }                                                \
        }
