...
#define U8_COUNT_TRAIL_BYTES(leadByte)                                                                                 \
    ((uint8_t)(leadByte) < 0xf0   ? ((uint8_t)(leadByte) >= 0xc0) + ((uint8_t)(leadByte) >= 0xe0)                      \
     : (uint8_t)(leadByte) < 0xfe ? 3 + ((uint8_t)(leadByte) >= 0xf8) + ((uint8_t)(leadByte) >= 0xfc)                  \
                                  : 0)
    ...
    {                                                                                                                  \
        ...
        if ( (c) >= 0x80 ) {                                                                                           \
            if ( (c) < 0xe0 ) {                                                                                        \
                ...
                (c) = (((c)&7) << 18) | (((s)[i] & 0x3f) << 12) | (((s)[(i) + 1] & 0x3f) << 6)                         \
                      | ((s)[(i) + 2] & 0x3f);                                                                         \
                (i) += 3;                                                                                              \
            }                                                                                                          \
        }                                                                                                              \
    ...
    {                                                                                                                  \
        ...
        if ( (c) >= 0x80 ) {                                                                                           \
            ...
            if ( /* handle U+1000..U+CFFF inline */                                                                    \
                 (0xe0 < (c) && (c) <= 0xec) && (((i) + 1) < (length) || (length) < 0)                                 \
                 && (__t1 = (uint8_t)((s)[i] - 0x80)) <= 0x3f && (__t2 = (uint8_t)((s)[(i) + 1] - 0x80)) <= 0x3f ) {   \
                /* no need for (c&0xf) because the upper bits are truncated after <<12 in the cast to (UChar) */       \
...
#define U8_FWD_1(s, i, length)                                                                                         \
    {                                                                                                                  \
        ...
        if ( U8_IS_LEAD(__b) ) {                                                                                       \
            ...
            if ( (i) + __count > (length) && (length) >= 0 ) { __count = (uint8_t)((length) - (i)); }                  \
...
#define U8_SET_CP_START(s, start, i)                                                                                   \
    {                                                                                                                  \
        if ( U8_IS_TRAIL((s)[(i)]) ) { (i) = utf8_back1SafeBody(s, start, (i)); }                                      \
    }
